...
访问[https://archive.apache.org/dist/hadoop/common/](https://archive.apache.org/dist/hadoop/common/)，下载hadoop-3.2.0安装包，在/data/soft目录下解压
...
```
访问界面
- HDFS webui界面：http://127.0.0.1:9870
- YARN webui界面：http://127.0.0.1:8088
